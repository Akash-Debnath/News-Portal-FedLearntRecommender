    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
                ...
                <form action="{{ route('roles-assign.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
    
                    <div class="col-md-6 col-12 mx-auto">
                        <label for="role"><strong>Employee</strong></label>
                        <input type="text" class="form-control" id="name" name="name" placeholder="Enter Name" value="{{ $user->first_name." ".$user->last_name }}" readonly>
                    </div><br>
